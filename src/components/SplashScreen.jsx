...
export function SplashScreen({ onFinish }) {
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(circle at 50% 32%, #14183A 0%, #0B1026 70%)", cursor: "pointer" }}
    >
      <div style={{ opacity: stage >= 1 ? 1 : 0, transform: stage >= 1 ? "translateY(0) scale(1)" : "translateY(10px) scale(0.94)", transition: "all 0.9s cubic-bezier(.2,.8,.2,1)" }}>
