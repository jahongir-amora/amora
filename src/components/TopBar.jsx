...
export function TopBar({ title, subtitle, onOpenMenu, showOrb, orbColor, orbPulse, rightSlot }) {
  return (
    <div className="flex items-center gap-3 px-5 pt-14 pb-4 flex-shrink-0" style={{ borderBottom: "1px solid var(--border)" }}>
      ...
      {showOrb && <PresenceOrb color={orbColor || "var(--accent)"} size={34} pulse={orbPulse} />}
